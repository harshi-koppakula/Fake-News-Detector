...
class FakeNewsDetectorApp(tk.Tk):
    ...
    def _set_style(self):
        ...
        self.light_colors = {
            ...
            "select_hover": "#2563EB",
            "upload_button": "#4CAF50",  # Dark green for upload buttons in light theme
            "upload_hover": "#43A047",    # Slightly darker green on hover
            "run_button": "#F59E0B",
            "run_hover": "#D97706",
            "clear_button": "#EF4444",
            "clear_hover": "#DC2626",
            ...
            "tree_fg": "#1F1F1F",
            "tree_alt": "#F3F4F6",
            "status_bg": "#ECECEC",  # Soft gray for status bar
            "status_fg": "#4B5563",
        }

        # Dark color palette (slightly lighter)
        self.dark_colors = {
            "bg": "#2A2A2A",
            "fg": "#D4D4D4",
            "select_button": "#3B82F6",
            "select_hover": "#2563EB",
            "upload_button": "#4CAF50",  # Dark green for upload buttons in dark theme
            "upload_hover": "#43A047",
            "run_button": "#F59E0B",
            "run_hover": "#D97706",
            "clear_button": "#EF4444",
    ...
    def create_widgets(self):
        ...
        self.theme_button = tk.Button(
            ...
            height=1,
            bg=self.colors["bg"],
            fg="#000000",  # Black for light theme
        ...
        # Position status bar above bottom padding, slightly above default bottom
        status_bar.pack(fill="x", side="bottom", padx=5, pady=(2, 8))
    ...
    def toggle_theme(self):
        if self.current_theme == "light":
            ...
            self.theme_button.config(text="☾", fg="#FFFFFF")  # Moon symbol for dark theme
            ...
            self.theme_button.config(text="☀", fg="#000000")  # Sun symbol for light theme
